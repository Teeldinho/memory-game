...
const Header = () => {
  ...
  return (
    <header className="relative z-10 flex justify-end w-full p-2 lg:py-8">
      ...
      <div className="flex gap-4 lg:gap-8">
        ...
        <button
          ...
          className="rounded-xl bg-[#D4190C] p-2 text-xs font-bold hover:opacity-90 lg:p-4 lg:text-xl"
        >
          Exit Game
        </button>
      </div>
